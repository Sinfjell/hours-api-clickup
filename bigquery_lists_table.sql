...
CREATE TABLE IF NOT EXISTS `nettsmed-internal.clickup_data.dim_clickup_lists` (
...
-- SELECT * FROM `nettsmed-internal.clickup_data.dim_clickup_lists` ORDER BY space_name, folder_name, list_name;
